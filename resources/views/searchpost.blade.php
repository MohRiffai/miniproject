...
<h4 style="margin-left: 100px; margin-bottom: -80px; margin-top: 50px">Telusuri : {{ $keywords}}</h4>
    <div class="article-container">
        @foreach ($results as $item)
        
            <div class="article">
                <title>Telusuri : {{ $keywords }}</title>
    ...
    <div class="pagination-links mt-4 d-flex justify-content-center">
        {{ $results->appends(['keywords' => $keywords])->links('pagination::bootstrap-4') }}
    </div>
@endsection
