...
<h4 style="margin-left: 100px; margin-bottom: -80px; margin-top: 50px">Tag / {{ $tag }}</h4>
    <div class="article-container">
        @foreach ($ArticlesbyTag as $item)
            <div class="article">
                <title>{{ $tag }} - Portal Berita</title>
    ...
    <div class="pagination-links mt-4 d-flex justify-content-center">
        {{ $ArticlesbyTag->links('pagination::bootstrap-4') }}
    </div>
